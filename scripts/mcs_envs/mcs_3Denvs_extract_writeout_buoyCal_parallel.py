...
def process_vars_env_writeout(i):
    ...
    vars_mcsenvs_all_xr.to_netcdf(out_dir / 'mcs_era5_3D_envs_{}.{}.LD.nc'.format(year, str(track_number).zfill(5)))
    print('mcs_era5_3D_envs_{}.{}.LD.nc ....saved'.format(year, str(track_number).zfill(5)))
