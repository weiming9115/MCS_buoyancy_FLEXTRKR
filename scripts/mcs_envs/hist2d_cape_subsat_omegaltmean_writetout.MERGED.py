...
if __name__ == '__main__':
    ...
    data_omega_ltmean = (data_omega.sel(level=950).w).rename('omega_ltmean')
    ...
    data_bins_duration.to_netcdf(out_dir / 'hist2d_cape_subsat_dtype.{}.{}.omega950.full.nc'.format(year,sampling_opt))
    print('hist2d_cape_subsat_dtype.{}.{}.omega950.full.nc'.format(year,sampling_opt))
