...
if __name__ == '__main__':
    ...
    ds.to_netcdf(out_dir / 'buoy_precipitation_multiregions.nonMCSshallow.Tb241.{}.nc'.format(year))
    print('buoy_precipitation_multiregions.nonMCSshallow.Tb241.{}.nc ...completed'.format(year))
