...
if __name__ == '__main__':
    ...
    for month in np.arange(1,13):
        ...
        prec_gpm_nonmcs = prec_gpm.where(mcsmask > 0)
        Buoy_TOT_nonmcs = Buoy_TOT.where(mcsmask > 0)
    ...
    ds.to_netcdf(out_dir / 'buoy_precipitation_multiregions.MCS.Tb241.{}.nc'.format(year))
    print('buoy_precipitation_multiregions.MCS.Tb241.{}.nc ...completed'.format(year))
